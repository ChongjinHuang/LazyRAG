...
DOCUMENT_LINK_GUIDANCE = (
    ...
    "content plus linked references. When the user asks to find a Notion page by "
    "title or keyword, use `NotionFS_search` first, then read the selected "
    "`notion_path`; Notion search is title/resource search, not full-text page "
    "body retrieval. For Notion, access is through the Notion "
